                                        ...
                                        <div class="col-sm-7">
                                            <select id="notaorder" name="notaorder" class="form-control select2" required>
                                                ...
                                                <?php foreach ($wholesale_order as $dt){ ?>
                                                    <?php if ((int)str_replace('.', '', $dt["amount_due"]) > 0) { ?>
                                                        <option value="<?=$dt["notaorder"]?>">
                                                            <?=$dt["notaorder"]?> (Subtotal: <?=$dt["subtotal"]?> - Sisa: <?=$dt["amount_due"]?>)
                                                        </option>
                                                    <?php } ?>
                                                <?php } ?>
                                            </select>
                                    ...
                                    <!-- <div class="form-group row">
                                        ...
                                        <div class="col-sm-7">
                                            <select id="notaorder" name="notaorder" class="form-control select2" required>
                                                <option value="" disabled selected>--Pilih Wholesale Order--</option>
                                                <?php foreach ($wholesale_order as $dt){?>
                                                    <option value="<?=$dt["notaorder"]?>"><?=$dt["notaorder"]?> (Subtotal: <?=$dt["subtotal"]?> - Sisa: <?=$dt["amount_due"]?>)</option>
                                                <?php } ?>
                                            </select>
                                        </div>
                                    </div> -->
