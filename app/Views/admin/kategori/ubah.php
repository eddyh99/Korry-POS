        		        ...
        		        <div class="col-lg-7">
                			<div class="card-body">
                			  <div class="form-group row">
                				...
                				<div class="col-sm-7">
                				  <input type="hidden" name="oldkategori" value="<?=$detail[0]->namakategori?>">
                				  <input type="text" class="form-control" id="kategori" name="kategori" maxlength="50" value="<?=$detail[0]->namakategori?>">
                				</div>
                			  </div>
                			</div>
        		        </div>
