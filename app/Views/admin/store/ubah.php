        ...
        <div class="row">
            <div class="card">
                ...
                <div class="card-content">
        	        <form id="form_input" method="post" action="<?=base_url()?>admin/store/update-data">
    		        <div class="col-lg-6">
            			<div class="card-body">
            			  <div class="form-group row">
            				<label class="col-sm-3 col-form-label">Nama Store</label>
            				<div class="col-sm-7">
            				  <input type="hidden" name="storeid" value="<?=$detail[0]->storeid?>">
            				  <input type="text" class="form-control" id="store" name="store" maxlength="50" value="<?=$detail[0]->store?>">
            				</div>
            			  </div>
            			  <div class="form-group row">
