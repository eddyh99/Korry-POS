        ...
        <div class="row">
            <div class="card">
                ...
                <div class="card-content">
        	        <form id="form_input" method="post" action="<?=base_url()?>admin/partner/update-data">
    		        <div class="col-lg-6">
            			<div class="card-body">
            			  <div class="form-group row">
            				<label class="col-sm-3 col-form-label">Nama Partner</label>
            				<div class="col-sm-7">
            				  <input type="hidden" name="partnerid" value="<?=$detail[0]->id?>">
            				  <input type="text" class="form-control" id="partner" name="partner" maxlength="50" value="<?=$detail[0]->nama?>">
            				</div>
            			  </div>
            			  <div class="form-group row">
        		        ...
        		        <div class="col-lg-12">
                    	    ...
                    	    <div class="col-lg-6 text-right">
                				<a name="btnBack" href="<?=base_url()?>admin/partner" class="btn btn-warning">
