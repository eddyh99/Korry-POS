...
<div class="sidebar" data-active-color="rose" style="background-color: #7F9192 !important;" data-image="<?=base_url()?>assets/img/sidebar-1.jpg"> 
    ...
    <div class="sidebar-wrapper">
        <div class="user">
            ...
            <ul class="nav">
            <?php if (@$_SESSION["logged_status"]["role"]=="Admin"):?>
                <li class="<?=@$mn_dash?>">
                ...
                <li class="<?=@$mn_setting?>">
                    ...
                    <div class="<?=@$colset?>" id="settings">
                        <ul class="nav">
                            ...
                            <li class="<?=@$side9?>">
                                <a href="<?=base_url()?>admin/pengeluaran">Pos Pengeluaran</a>
                            </li>
                            <li class="<?=@$side10?>">
                                <a href="<?=base_url()?>admin/metodebayar">Bank Penerima</a>
                            </li>
                            <li class="<?=@$side11?>">
            ...
            <?php endif; ?>
            <li>
                <a href="<?= site_url('auth/auth_logout') ?>">
